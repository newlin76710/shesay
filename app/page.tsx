...
export default function HomePage() {
  return (
    <main>
      <section className="mx-auto flex min-h-screen max-w-6xl items-center px-6 py-20 sm:px-8 lg:px-10">
        <div className="grid gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
          ...
          <div className="rounded-[2rem] border border-white/70 bg-white/85 p-8 shadow-soft backdrop-blur">
            ...
            <div className="mt-6 rounded-[1.5rem] bg-plum p-6 text-white">
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-gold">A softer way to connect</p>
              <p className="mt-4 text-2xl font-semibold leading-snug">不是盲目配對，而是幫妳更靠近真正適合的人。</p>
              <p className="mt-4 text-sm leading-7 text-white/75">
                把單身、戀愛、社交與自我理解，整理成更清楚、更舒服的一條路。
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="mx-auto grid max-w-6xl gap-8 px-6 py-16 sm:px-8 lg:grid-cols-2 lg:px-10 lg:py-24">
        <article className="rounded-[2rem] bg-plum p-8 text-white shadow-soft md:p-10">
        ...
        <article id="consult" className="rounded-[2rem] border border-white/70 bg-white p-8 shadow-soft md:p-10">
