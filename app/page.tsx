          ...
          <div className="mt-12 grid gap-10 lg:grid-cols-2 lg:items-start">
            ...
            <div>
              ...
              <div className="mt-5 flex flex-col items-center gap-3">
                ...
                <a href="/calculator" className="inline-flex rounded-full border border-plum/20 bg-white px-6 py-3 text-sm font-semibold text-plum transition hover:border-rose/30 hover:text-rose">
                  免費速測妳的戀愛數字
                </a>
